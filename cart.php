        ...
        <div class="col-lg-4 ml-auto bg-white shadow-sm pt-4 mx-3">
          ...
          <div class="p-4">
            <ul class="list-unstyled mb-4">
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Produits </strong><strong><?php echo !(empty($_SESSION['count'])) ? $_SESSION['count'] : "" ?></strong></li>
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                <h5 class="font-weight-bold"><?php echo !(empty($_SESSION['totaux'])) ? $_SESSION['totaux'].' DHS' : "" ?></h5>
              </li>
            </ul><a href="credit-card.php" class="btn btn-dark rounded-pill py-2 btn-block">Procéder au paiement</a>
          </div>
        </div>
      </div>
      <?php
