<?php
	...
	if($check > 0){ // ca veut dire que cette categorie existe !!
		...
		<?php
			...
			echo"<div class='alert alert-warning empty-category'><strong>".'Cette catégorie est vide! Veuillez la vérifier une autre fois'."</strong></div>";
			echo "</div>";echo "</div>";echo "</div>";echo "</div>";echo "</div>";echo "</div>";
			echo "</div>";echo "</div>";echo "</section>";
		}
	}else{
		$message='<div class="alert alert-danger">'.'Il n\'y a pas de catégorie avec cet identifiant'.'</div>';
